...
Whatever comes after, or whatever comes later, is going to be the winner in the event of a conflict. 
When overriding the values that are here in the props, so position and syntax matters.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=david%40d2creativedesign.com).
