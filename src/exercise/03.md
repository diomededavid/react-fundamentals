...
Spread operator takes combined props and returns them in order;
...
```jsx
    ...
    const children = 'Hello Bob Props';
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=david%40d2creativedesign.com).
