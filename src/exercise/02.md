...
## 📝 Your Notes
Declarative programming - Is the how. Assumes that you know all the steps to get to where you are going.

Imperative programming - Is the specific steps to get to where you are going

Start with `.map`, `.reduce`, `.filter` and work up.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=david%40d2creativedesign.com).
